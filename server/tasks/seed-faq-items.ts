...
export const imageDirectLiks = [
  ...
  "https://seo2you.ru/upload/images/vnutrennie-ssylki-faktor-ranzhirovaniya2.png",
  "https://seo2you.ru/upload/images/vnutrennie-ssylki-faktor-ranzhirovaniya4.png",
  "https://seo2you.ru/upload/images/vnutrennie-ssylki-faktor-ranzhirovaniya3.png",
...
export default defineTask({
  async run(event) {
    ...
    for (const i of Array(faqItemsAmount)) {
      ...
      const preImages: Image[] = Array(randNumber({ start: 0, end: maxImagesAmountByItem }))
        .fill(null)
        .map((i) => ({
      ...
      for (const preImage of preImages) {
        const data = preImage
        const refer_id = db_faq_item.id
        const refer_type = "faq"
