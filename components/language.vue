...
<template>
	<div
		class="on-hover border-D rounded-[.5vw] w-max border-white font-semibold pt-D-5 pb-D-5 text-M-10 ps-M-10 pe-M-10 me-M-10 ms-auto md:me-0 md:ps-D-15 md:pe-D-15 md:text-D-20"
